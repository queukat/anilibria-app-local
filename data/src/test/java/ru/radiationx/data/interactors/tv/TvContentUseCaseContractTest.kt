...
class TvContentUseCaseContractTest {
    ...
    @Test
    fun loadMainFeed_usesLatestWithoutFields_andFallsBackToCatalogWhenLatestIsEmpty() = runBlocking {
        ...
        coEvery { aniLibertyApi.getCatalogReleases(capture(catalogRequestSlot)) } returns PaginatedResponse(
