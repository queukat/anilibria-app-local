...
fun DonationInfoResponse.toDomain() =
    DonationInfo(
...
fun DonationCardResponse.toDomain() =
    DonationCard(
        title = title,
        subtitle = subtitle,
    )
...
fun DonationContentItemResponse.toDomain(): DonationContentItem? =
    when (type) {
...
fun DonationContentButtonResponse.toDomain() =
    DonationContentButton(
        tag = tag,
        text = text,
        link = link,
        brand = brand,
...
fun DonationContentCaptionResponse.toDomain() =
    DonationContentCaption(
        text = text,
    )

fun DonationContentDividerResponse.toDomain() =
    DonationContentDivider(
        height = height,
    )

fun DonationContentHeaderResponse.toDomain() =
    DonationContentHeader(
        text = text,
    )

fun DonationContentSectionResponse.toDomain() =
    DonationContentSection(
        title = title,
        subtitle = subtitle,
    )

fun DonationDialogResponse.toDomain() =
    DonationDialog(
        tag = tag,
