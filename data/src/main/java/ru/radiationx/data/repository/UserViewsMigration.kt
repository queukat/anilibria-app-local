...
class UserViewsMigration
    ...
    constructor(
        ...
        private suspend fun upsertAll(upserts: List<AniLibertyUserViewTimecodeUpsertBody>): Boolean {
        ...
        private suspend fun updateLocal(localUpdates: List<EpisodeAccess>): Boolean {
            ...
            val merged =
                buildMap<EpisodeId, EpisodeAccess> {
