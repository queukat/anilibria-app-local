...
class FavoriteRepository
    ...
    constructor(
        ...
        private suspend fun mapAniLibertyFavorites(response: PaginatedResponse<AniLibertyRelease>): Paginated<Release> {
        ...
        private suspend fun enrichAmbiguousFavorites(releases: List<AniLibertyRelease>): List<AniLibertyRelease> {
            val ambiguousIds =
                releases
                    .mapNotNull { release ->
        ...
        private fun createMinimalRelease(
            releaseId: ReleaseId,
            isFavorite: Boolean,
        ): Release {
            return Release(
