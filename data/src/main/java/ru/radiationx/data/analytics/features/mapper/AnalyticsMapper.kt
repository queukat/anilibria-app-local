...
fun AuthState.toAnalyticsAuthState(): AnalyticsAuthState =
    when (this) {
...
fun PlayerQuality.toAnalyticsQuality(): AnalyticsQuality =
    when (this) {
...
fun PlayerTransport.toAnalyticsTransport(): AnalyticsTransport =
    when (this) {
