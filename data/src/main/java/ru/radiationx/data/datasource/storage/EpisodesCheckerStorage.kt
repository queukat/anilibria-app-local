...
class EpisodesCheckerStorage
    ...
    constructor(
        ...
        private val localEpisodesRelay =
        ...
        override fun observeEpisodes(): Flow<List<EpisodeAccess>> = localEpisodesRelay
        ...
        override suspend fun putAllEpisodeBatched(
            ...
            writeMutex.withLock {
                ...
                val mergedByEpisodeId =
                    localEpisodesRelay.getValue()
                        .associateBy { it.id }
                        .toMutableMap()
        ...
        private fun resolveEpisodeConflict(
            ...
            val hasComparableFreshTimestamps =
                currentLastAccess > 0L &&
