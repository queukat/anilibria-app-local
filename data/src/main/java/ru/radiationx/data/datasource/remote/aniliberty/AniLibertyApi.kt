...
class AniLibertyApi @Inject constructor(
    ...
    override suspend fun passwordReset(token: String, password: String, passwordConfirmation: String) {
    ...
    override suspend fun getUserFavoriteReleases(page: Int, limit: Int, fields: AniLibertyFieldSpec?): PaginatedResponse<AniLibertyRelease> {
        val args = AniLibertyQueryParams.build {
            put("page", page.toString())
            put("limit", limit.toString())
            applyFields(fields)
    ...
    override suspend fun getUserFavoriteReleasesFiltered(request: AniLibertyFavoritesFilterRequest): PaginatedResponse<AniLibertyRelease> {
        val args = AniLibertyQueryParams.build {
            put("page", request.page.value.toString())
            put("limit", request.limit.value.toString())
    ...
    override suspend fun getUserCollectionReleasesFiltered(request: AniLibertyCollectionsFilterRequest): PaginatedResponse<AniLibertyRelease> {
        val args = AniLibertyQueryParams.build {
            put("page", request.page.value.toString())
            put("limit", request.limit.value.toString())
    ...
    override suspend fun getRandomFranchises(limit: Int?, fields: AniLibertyFieldSpec?): List<AniLibertyFranchise> {
        val args = AniLibertyQueryParams.build {
            putIfPositive("limit", limit)
            applyFields(fields)
        }
...
// Genres
    ...
    override suspend fun getGenre(genreId: AniLibertyGenreId, fields: AniLibertyFieldSpec?): AniLibertyGenre {
        val args = AniLibertyQueryParams.build { applyFields(fields) }
        val json = client.get("${Config.BaseUrl}/anime/genres/${genreId.value}", args)
        return json.fetchResponse(moshi)
    }

    override suspend fun getRandomGenres(limit: Int?, fields: AniLibertyFieldSpec?): List<AniLibertyGenre> {
        val args = AniLibertyQueryParams.build {
            putIfPositive("limit", limit)
            applyFields(fields)
        }
...
// Torrents
    ...
    override suspend fun getTorrents(page: Int, limit: Int): ru.radiationx.data.entity.response.PaginatedResponse<AniLibertyTorrent> {
        val args = AniLibertyQueryParams.build {
            put("page", page.toString())
            put("limit", limit.toString())
        }
