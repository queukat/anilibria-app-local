...
sealed interface PlayerCommand {
    data class Play(val revealControls: Boolean = false) : PlayerCommand
...
class PlayerViewModel
    ...
    constructor(
        ...
        private val _commands =
            MutableSharedFlow<PlayerCommand>(
                replay = 0,
        ...
        fun onPrepare(duration: Long) {
            ...
            viewModelScope.launch {
                ...
                if (completedSeek) {
                    ...
                    emitCommand(PlayerCommand.Play(revealControls = false))
                }
            }
        }
