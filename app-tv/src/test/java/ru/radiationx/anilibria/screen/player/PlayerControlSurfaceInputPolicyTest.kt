...
class PlayerControlSurfaceInputPolicyTest {
    ...
    fun centerPress_consumesOnKeyDown() {
        val result = resolvePlayerControlSurfaceKeyAction(
            canFocus = true,
            enabled = true,
    ...
    fun moveRight_onlyMovesOnKeyDown() {
        val keyDownResult = resolvePlayerControlSurfaceKeyAction(
            canFocus = true,
            enabled = true,
            key = Key.DirectionRight,
            eventType = KeyEventType.KeyDown,
        )
        val keyUpResult = resolvePlayerControlSurfaceKeyAction(
            canFocus = true,
            enabled = true,
            key = Key.DirectionRight,
            eventType = KeyEventType.KeyUp,
